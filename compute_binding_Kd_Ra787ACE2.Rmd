---
title: "Compute per-barcode Ra787ACE2 binding affinity"
author: "Tyler Starr"
date: "01/02/2023"
output:
  github_document:
...
This notebook reads in per-barcode counts from `count_variants.ipynb` for Ra787ACE2-binding Tite-seq experiments, computes functional scores for RBD ACE2-binding affiniity, and does some basic QC on variant binding functional scores.
...
We successfully generated *K*<sub>D</sub> estimates for `r sum(!is.na(dt[library=="lib40",Kd_Ra787ACE2]))` of our lib40 barcodes (`r round(sum(!is.na(dt[library=="lib40",Kd_Ra787ACE2]))/nrow(dt[library=="lib40",])*100,digits=2)`%). 
...
We have generated binding measurements for `r round(nrow(dt[!is.na(log10Ka_Ra787ACE2)])/nrow(dt)*100,digits=2)`% of the barcodes in our libraries.
