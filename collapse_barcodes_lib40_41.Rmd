...
---
This notebook reads in the per-barcode ACE2 binding phenos and collapses barcodes to final mean binding for each variant, and generates some coverage and QC analyses. It also makes some heatmaps and other visualizations of these data.
...
Some QC plots. First, look at distribution of number barcodes for single mutant detemrinations in each library. These are 'left-justified' histograms, so the leftmost bar represents the number of genotypes for which no barcodes were collapsed to final measurement in a pool.

```{r hist_n_bc_per_mutant, fig.width=6, fig.height=16, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(8,2))
#huACE2
...
```{r sem_v_n-bc, fig.width=6, fig.height=24, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(8,2))
#huACE2
...
We have duplicate measurements! For huACE2 and expression, we duplicated both lib40 and lib41. For the other ACE2s, we have a limited replicate with the shared mutations that are present in lib46. The lib40/lib41 correlations first are below, for the entire pool and for particular variants:

```{r correlatiosn_lib40-41_expression_all, echo=T, fig.width=4.5, fig.height=4.5, fig.align="center", dpi=300,dev="png"}
...
```{r correlatiosn_lib40-41_expression_by-bg, echo=T, fig.width=8, fig.height=12, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(3,2))
...
```{r correlatiosn_lib40-41_huACE2_all, echo=T, fig.width=4.5, fig.height=4.5, fig.align="center", dpi=300,dev="png"}
...
```{r correlatiosn_lib40-41_huACE2_by-bg, echo=T, fig.width=8, fig.height=12, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(3,2))
...
Now, for lib40/46 correlations. Need to merge in the collapsed bc lib46 measurements for the correspoding SARS1 and SARS2 mutagenesis
```{r merge_lib46, echo=T, fig.width=8, fig.height=4, fig.align="center", dpi=300,dev="png"}
...
Correlations for each ACE2 (including huACE2 lib40 vs lib46 even though we have 40/41 above) pooled across all backgrounds

```{r correlatiosn_lib40-46_all-traits, echo=T, fig.width=6, fig.height=12, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(4,2))
#huACE2
...
For huACE2 and expression we have both lib40 and lib41 measurements, so let's collapse the two.

```{r collapse_reps, echo=T, fig.width=8, fig.height=4, fig.align="center", dpi=300,dev="png"}
dt <- copy(dt_mutant)
...
```
Censor any measurements that are from a single bc and/or below a certain SEM? don't do this for now, let's visualize first
...
```{r n_barcode_plots, echo=T, fig.width=8, fig.height=12, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(4,2))
#huACE2
...
```
Make heatmaps faceted by target, showing raw affinity and delta-affinity of muts relative to respective wt

First, huACE2
```{r heatmap_DMS_huACE2-by-target_log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
And delta, huACE2
```{r heatmap_DMS_huACE2-by-target_delta-log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Next, Ra787ACE2
```{r heatmap_DMS_Ra787ACE2-by-target_log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
And delta, Ra787ACE2
```{r heatmap_DMS_Ra787ACE2-by-target_delta-log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Next, Ra9479ACE2
```{r heatmap_DMS_Ra9479ACE2-by-target_log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_Ra9479ACE2-by-target_delta-log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Next, RlanACE2
```{r heatmap_DMS_RlanACE2-by-target_log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
And delta, RlanACE2
```{r heatmap_DMS_RlanACE2-by-target_delta-log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Next, RalcACE2
```{r heatmap_DMS_RalcACE2-by-target_log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
And delta, RalcACE2
```{r heatmap_DMS_RalcACE2-by-target_delta-log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Next, RshACE2
```{r heatmap_DMS_RshACE2-by-target_log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
And delta, RshACE2
```{r heatmap_DMS_RshACE2-by-target_delta-log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Next, RpearACE2
```{r heatmap_DMS_RpearACE2-by-target_MFI, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
And delta, RpearACE2
```{r heatmap_DMS_RpearACE2-by-target_delta-MFI, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Next, expression
```{r heatmap_DMS_expression-by-target_log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_expression-by-target_delta-log10Ka, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
