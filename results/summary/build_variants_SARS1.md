...
# Build Variants
This Python Jupyter notebook processes the nt-level barcode lookup table for the SARS1 (Urbani) background to generate a protein-level barcode-variant lookup table and analyze mutation coverage.
...
```
    ...
    Read 70829 consensus sequences from 2 libraries and 1 targets.
...
```
    ...
    Read gene of 600 nts for SARS-CoV-1_2693 from data/PacBio_amplicon_SARS1.gb
...
![png](build_variants_SARS1_files/build_variants_SARS1_25_0.png)
...
```
    ...
    Saving plot to results/figures/n_aa_muts_per_variant_SARS-CoV-1_2693.pdf
    Saving plot to results/figures/n_codon_muts_per_variant_SARS-CoV-1_2693.pdf



    
![png](build_variants_SARS1_files/build_variants_SARS1_27_1.png)
    



    
![png](build_variants_SARS1_files/build_variants_SARS1_27_2.png)
...
```
    ...
    Saving plot to results/figures/avg_muts_per_variant_SARS-CoV-1_2693.pdf



    
![png](build_variants_SARS1_files/build_variants_SARS1_29_1.png)
...
![png](build_variants_SARS1_files/build_variants_SARS1_31_0.png)
...
```
    ...
    Saving plot to results/figures/variant_cumul_all_mut_coverage_SARS-CoV-1_2693.pdf
    Saving plot to results/figures/variant_cumul_single_mut_coverage_SARS-CoV-1_2693.pdf



    
![png](build_variants_SARS1_files/build_variants_SARS1_33_1.png)
    



    
![png](build_variants_SARS1_files/build_variants_SARS1_33_2.png)
...
![png](build_variants_SARS1_files/build_variants_SARS1_37_0.png)
    



    
![png](build_variants_SARS1_files/build_variants_SARS1_37_1.png)
...
![png](build_variants_SARS1_files/build_variants_SARS1_39_0.png)
    



    
![png](build_variants_SARS1_files/build_variants_SARS1_39_1.png)
...
```
    ...
    Writing codon-variant table to results/variants/codon_variant_table_SARS1.csv
