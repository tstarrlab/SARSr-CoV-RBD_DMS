...
# Build Variants
This Python Jupyter notebook processes the nt-level barcode lookup table for the PRD-0038 background to generate a protein-level barcode-variant lookup table and analyze mutation coverage.
...
```
    ...
    Read 71996 consensus sequences from 2 libraries and 1 targets.
...
```
    ...
    Read gene of 600 nts for PRD-0038 from data/PacBio_amplicon_PRD0038.gb
...
![png](build_variants_PRD0038_files/build_variants_PRD0038_25_0.png)
...
```
    ...
    Saving plot to results/figures/n_aa_muts_per_variant_PRD-0038.pdf
    Saving plot to results/figures/n_codon_muts_per_variant_PRD-0038.pdf



    
![png](build_variants_PRD0038_files/build_variants_PRD0038_27_1.png)
    



    
![png](build_variants_PRD0038_files/build_variants_PRD0038_27_2.png)
...
```
    ...
    Saving plot to results/figures/avg_muts_per_variant_PRD-0038.pdf



    
![png](build_variants_PRD0038_files/build_variants_PRD0038_29_1.png)
...
![png](build_variants_PRD0038_files/build_variants_PRD0038_31_0.png)
...
```
    ...
    Saving plot to results/figures/variant_cumul_all_mut_coverage_PRD-0038.pdf
    Saving plot to results/figures/variant_cumul_single_mut_coverage_PRD-0038.pdf



    
![png](build_variants_PRD0038_files/build_variants_PRD0038_33_1.png)
    



    
![png](build_variants_PRD0038_files/build_variants_PRD0038_33_2.png)
...
![png](build_variants_PRD0038_files/build_variants_PRD0038_37_0.png)
    



    
![png](build_variants_PRD0038_files/build_variants_PRD0038_37_1.png)
...
![png](build_variants_PRD0038_files/build_variants_PRD0038_39_0.png)
    



    
![png](build_variants_PRD0038_files/build_variants_PRD0038_39_1.png)
...
```
    ...
    Writing codon-variant table to results/variants/codon_variant_table_PRD0038.csv
