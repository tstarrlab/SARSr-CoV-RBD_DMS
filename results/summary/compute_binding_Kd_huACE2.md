Compute per-barcode huACE2 binding affinity
================
Tyler Starr
7/12/2021

This notebook reads in per-barcode counts from `count_variants.ipynb`
for huACE2-binding Tite-seq experiments, computes functional scores for
...
```
    ...
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_01_bin1 is 1.38008959655684"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_01_bin2 is 1.19130391688837"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_01_bin3 is 1.23935468052053"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_01_bin4 is 1.25904347980285"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_02_bin1 is 1.19276662359969"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_02_bin2 is 1.24622549071255"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_02_bin3 is 1.10881041044318"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_02_bin4 is 1.37423613751333"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_03_bin1 is 1.37423701425477"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_03_bin2 is 1.28462359294217"
    ## [1] "reads < cells for lib41 TiteSeq_huACE2_03_bin3 , un-normalized (ratio 0.833519734372832 )"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_03_bin4 is 1.34325199039845"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_04_bin1 is 1.31441168850707"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_04_bin2 is 1.14619495052139"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_04_bin3 is 1.23390147107976"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_04_bin4 is 1.32146564771194"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_05_bin1 is 1.34920483998355"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_05_bin2 is 1.83692945517753"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_05_bin3 is 1.44918884724794"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_05_bin4 is 1.49574698032803"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_06_bin1 is 1.54446752566478"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_06_bin2 is 1.54421364816032"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_06_bin3 is 10.4684057971014"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_06_bin4 is 23.5306666666667"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_07_bin1 is 1.39318723513058"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_07_bin2 is 1.25392246861062"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_07_bin3 is 3.20879120879121"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_07_bin4 is 128.235042735043"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_08_bin1 is 1.2112818080195"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_08_bin2 is 1.2176446140581"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_08_bin3 is 32.0914454277286"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_08_bin4 is 21.8741258741259"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_09_bin1 is 1.65009642750609"
    ## [1] "reads < cells for lib41 TiteSeq_huACE2_09_bin2 , un-normalized (ratio 0.995788957314173 )"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_09_bin3 is 8.2680412371134"
    ## [1] "read:cell ratio for lib41 TiteSeq_huACE2_09_bin4 is 7.52173913043478"
    ## [1] "read:cell ratio for lib40 TiteSeq_huACE2_01_bin1 is 1.07479691690889"
    ## [1] "read:cell ratio for lib40 TiteSeq_huACE2_01_bin2 is 1.10395972241121"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_01_bin3 , un-normalized (ratio 0.690522199912438 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_01_bin4 , un-normalized (ratio 0.750700596256218 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_02_bin1 , un-normalized (ratio 0.682604054073517 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_02_bin2 , un-normalized (ratio 0.584553074223816 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_02_bin3 , un-normalized (ratio 0.689038164623505 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_02_bin4 , un-normalized (ratio 0.760668870380548 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_03_bin1 , un-normalized (ratio 0.706110555015457 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_03_bin2 , un-normalized (ratio 0.607909908158268 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_03_bin3 , un-normalized (ratio 0.629680131648281 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_03_bin4 , un-normalized (ratio 0.696481761950657 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_04_bin1 , un-normalized (ratio 0.678956669783406 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_04_bin2 , un-normalized (ratio 0.590729414566 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_04_bin3 , un-normalized (ratio 0.695922258441479 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_04_bin4 , un-normalized (ratio 0.674811692329053 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_05_bin1 , un-normalized (ratio 0.746325789794769 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_05_bin2 , un-normalized (ratio 0.684136863579433 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_05_bin3 , un-normalized (ratio 0.695436907100536 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_05_bin4 , un-normalized (ratio 0.742603407500362 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_06_bin1 , un-normalized (ratio 0.778516884499717 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_06_bin2 , un-normalized (ratio 0.643806120668871 )"
    ## [1] "read:cell ratio for lib40 TiteSeq_huACE2_06_bin3 is 1.01008711600183"
    ## [1] "read:cell ratio for lib40 TiteSeq_huACE2_06_bin4 is 19.0941704035874"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_07_bin1 , un-normalized (ratio 0.773931381379822 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_07_bin2 , un-normalized (ratio 0.636939776448702 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_07_bin3 , un-normalized (ratio 0.509833585476551 )"
    ## [1] "read:cell ratio for lib40 TiteSeq_huACE2_07_bin4 is 95.1942857142857"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_08_bin1 , un-normalized (ratio 0.73398002419992 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_08_bin2 , un-normalized (ratio 0.555834988591034 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_08_bin3 , un-normalized (ratio 0.257918552036199 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_08_bin4 , un-normalized (ratio 0.995327102803738 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_09_bin1 , un-normalized (ratio 0.728638237766802 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_09_bin2 , un-normalized (ratio 0.662284282926694 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_09_bin3 , un-normalized (ratio 0.423328964613368 )"
    ## [1] "reads < cells for lib40 TiteSeq_huACE2_09_bin4 , un-normalized (ratio 0.809843400447427 )"
...
For the library 2 dimeric ACE2 titration sorts, the fluorescence
boundaries for bins 1-4 are as follows:
...
We successfully generated *K*<sub>D</sub> estimates for 188004 of our
lib40 barcodes (88.12%) and 197930 of our lib2 barcodes (89.13%).
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/avgcount-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/Kd_distribution-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/1e-5_Kd-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/1e-6_Kd-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/1e-7_Kd-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/1e-8_Kd-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/1e-9_Kd-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/1e-10_Kd-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/1e-11_Kd-1.png" style="display: block; margin: auto;" />
...
filtering based on 25x the global median (and percentage filtered from
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/nMSR_v_cell_count-1.png" style="display: block; margin: auto;" />
...
<img src="compute_binding_Kd_huACE2_files/figure-gfm/binding_distribution_vioplot-1.png" style="display: block; margin: auto;" />
...
We have generated binding measurements for 87.97% of the barcodes in our
libraries.
